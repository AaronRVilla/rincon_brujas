      ...
      <v-app style="background-color: #cba0e4;">
            <v-container class="my-auto">
                  <v-col cols="10" lg="5" class="mx-auto">
                        <v-card color="#EEEEEE" class="d-flex flex-column px-5 py-5">
                              <v-card-title class="mx-auto">Nuevo apartado</v-card-title>
                              <v-card-text>
                                    <v-form ref="newsale">
                                          ...
                                          <v-text-field label="Forma de pago"></v-text-field>
                                          <v-text-field label="Total a pagar"></v-text-field>
                                          <v-text-field label="Estado"></v-text-field>
                                          <v-text-field label="Abono"></v-text-field>
                                    </v-form>
                              </v-card-text>
                              <v-actions>
